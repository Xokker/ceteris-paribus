...
public class Cars2 {
    ...
    private Stats crossValidation(Map<Identifiable, Set<CarAttribute>> objects,
        ...
        for (int removedElementBucketIndex = 0; removedElementBucketIndex < objects.keySet().size(); removedElementBucketIndex++) {
            Identifiable removedElement = ii(removedElementBucketIndex);
